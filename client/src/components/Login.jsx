    ...
    <h1>Log in.</h1>
      <div className="row">
        <div className="input-field col s6">
          ...
          <input type="email" id="icon_user" className="validate" name="username" onChange= {this.handleNameChange}/>
        ...
        <button type="submit" className="btn-large waves-effect waves-light cyan" style={{marginLeft: "20px"}}>Login</button>
      </div>
    </form>
    </div>
  </div>
